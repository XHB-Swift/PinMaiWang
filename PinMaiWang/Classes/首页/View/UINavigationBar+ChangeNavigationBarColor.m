//
//  UINavigationBar+ChangeNavigationBarColor.m
//  PinMaiWang
//
...
@implementation UINavigationBar (ChangeNavigationBarColor)
...
- (void)changeColor:(UIColor *)color WithScrollView:(UIScrollView *)scrollView AndValue:(CGFloat)value {
    if (scrollView.contentOffset.y < 0) {
        ...
        self.hidden = NO;
        //计算透明度
        CGFloat alpha = scrollView.contentOffset.y /self.bounds.size.width/1.5 >1.0f ? 1:scrollView.contentOffset.y/self.bounds.size.width/1.5;
        //设置一个颜色并转化为图片
