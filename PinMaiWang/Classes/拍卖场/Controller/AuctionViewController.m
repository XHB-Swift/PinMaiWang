...
-(UIView *)oneView{
    ...
    if (!_oneView) {
        self.oneView = [[UIView alloc]initWithFrame:CGRectMake(0, 94, XHB_SCREEN_WIDTH, XHB_SCREEN_HEIGHT)];
        self.oneView.backgroundColor = [UIColor whiteColor];
        UILabel *label = [[UILabel alloc]initWithFrame:CGRectMake(0, 0, XHB_SCREEN_WIDTH, XHB_SCREEN_HEIGHT/2)];
...
-(UIView *)twoView{
    ...
    if (!_twoView) {
        ...
        self.twoView = [[UIView alloc]initWithFrame:CGRectMake(0, 94, XHB_SCREEN_WIDTH, XHB_SCREEN_HEIGHT)];
        self.twoView.backgroundColor =[UIColor yellowColor];
...
-(UIView *)threeView{
    ...
    if (!_threeView) {
        self.threeView = [[UIView alloc]initWithFrame:CGRectMake(0, 94, XHB_SCREEN_WIDTH, XHB_SCREEN_HEIGHT)];
        self.threeView.backgroundColor = [UIColor greenColor];
...
-(void)setUpSegmnetedController{
    ...
    self.segment.frame = CGRectMake(0, 64, XHB_SCREEN_WIDTH, 30);
